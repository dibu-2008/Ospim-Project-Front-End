...
export const DetalleOtrosPagos = ({ data }) => {
    const { fechaPago, entidad, razonPago, nroActa, descripcionPago, importe, tipoPagoUOMA } = data;
    ...
    return (
        <Box p={3} className="otros_pagos_container">
            ...
            <Grid container spacing={2}>
                ...
                {entidad === "UOMA" && (
                    <Grid item xs={12} sm={6}>
                        <Typography variant="body1">Tipo de Pago UOMA: {tipoPagoUOMA}</Typography>
                    </Grid>
                )}
                ...
                <Grid item xs={12}>
                    <Typography variant="body1">Descripción del Pago: {descripcionPago}</Typography>
                </Grid>
                <Grid item xs={12}>
