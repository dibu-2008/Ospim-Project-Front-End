...
export const obtenerDeclaracionesJuradas = async (token) => {
...
export const presentarDeclaracionJurada = async (idDeclaracionJurada, estado, token) => {

    const URL = `${BACKEND_URL}/empresa/:empresaId/dj/${idDeclaracionJurada}/presentar`;
