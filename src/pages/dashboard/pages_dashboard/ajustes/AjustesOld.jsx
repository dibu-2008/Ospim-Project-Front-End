...
export const Ajustes = () => {
  ...
  const columns = [
      ...
      { field: 'nro_boleta', headerName: 'NRO BOLETA', width: 150, editable: false },
      {
        field: 'acciones',
        headerName: 'ACCIONES',
        width: 200,
  ...
  const onChangeValue = (params) => {
      ...
      newAjustes[rowIndex] = { ...newAjustes[rowIndex], [params.field]: params.value };
  ...
  return (
          <Box className="ajustes_container" style={{ height: 400, width: '100%' }}
          sx={{
            width: '100%',
                      ...
                      components={{
                        Toolbar: () => (
                          <GridToolbarContainer>
                            ...
                            <GridToolbarExport/>
                            <Button color="primary" startIcon={<AddIcon />} onClick={handleNuevoAjuste} style={{fontSize: '0.8125rem'}}>
                              Nuevo Registro
                            </Button>
                          </GridToolbarContainer>
                        ),
